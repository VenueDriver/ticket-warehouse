            ...
            custom_sql: {
              ...
              sql_query: <<~SQL,
                SELECT
                  ...
                  "Order".paid_date_utc AS final_at_UTC,
                  'false' AS void,
                  'Stripe' AS payment_gateway,
                  '' AS learned_from,
                  ticket_data.id AS id,
                  "Order".paid_date_utc AS created_at_UTC,
                  "Order".event_id AS event_id,
                  ticket_data.redeemed AS ticket_redeemed,
                  ticket_data.promo_code AS ticket_promo_code
              FROM 
                  ticket_warehouse.ticket_warehouse_events AS Event
              INNER JOIN
                  ticket_warehouse.ticket_warehouse_orders AS "Order"
